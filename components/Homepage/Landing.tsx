    ...
    <div className="relative md:min-h-[200vh] h-[100vh] overflow-hidden">
      <div className=" absolute top-0 left-0 w-full">
        <video
          ...
          autoPlay
          muted
          className=" sm:flex hidden h-full w-full"
        ></video>
        <Image
      ...
      <div className="relative top-32 text-center">
        <h1 className=" font-regular md:text-[3rem] text-[1.5rem] text-white ">
          Top Web Design Agency
        </h1>
        <h2 className={`font-bold md:text-[4.5rem] text-[3rem] text-white `}>
        ...
        <Link
          href={"/contact"}
          className=" c-btn font-bold -primary-v2 -dark -see hover:bg-transparent hover:text-white py-3 px-10 ImportantWhite"
        >
          Contact us
        </Link>
      </div>
